...
const productReviews: ProductReview[] = [
  {
    rank: 1,
    name: "Wooting 80HE",
    tagline: "Le roi incontesté des claviers compétitifs",
    rating: 9.6,
    price: "199€",
    specs: [
      { label: "Switch", value: "Hall Effect" },
      { label: "Format", value: "TKL (80%)" },
      { label: "Connexion", value: "USB-C" },
      { label: "Actuation", value: "0.1-4.0mm" },
    ],
    pros: [
      "Actuation point ajustable de 0.1mm à 4.0mm",
      "Rapid Trigger pour un reset instantané",
      "Build quality exceptionnelle (alu CNC)",
      "Son de frappe satisfaisant stock",
    ],
    cons: [
      "Pas de sans-fil (USB-C uniquement)",
      "Disponibilité limitée (souvent en rupture)",
      "Pas de macro keys dédiées",
    ],
  ...
  },
  {
    ...
    tagline: "Le premium sans compromis",
    rating: 9.3,
    price: "249€",
    specs: [
      { label: "Switch", value: "Analog Optical" },
      { label: "Format", value: "Full / TKL" },
      { label: "Connexion", value: "USB-C / 2.4GHz" },
      { label: "Actuation", value: "0.1-4.0mm" },
    ],
    pros: [
      "Switches analog optiques ultra-rapides",
      "Build quality premium avec repose-poignet magnétique",
      "Razer Synapse puissant pour la personnalisation",
      "Disponible en Full et TKL",
    ],
    cons: [
      "Prix élevé (249€+)",
      "Logiciel Synapse parfois lourd",
      "Repose-poignet en plastique (pas cuir)",
    ],
  ...
  },
  {
    ...
    tagline: "Le mastodonte polyvalent",
    rating: 9.1,
    price: "189€",
    specs: [
      { label: "Switch", value: "OPX Optical" },
      { label: "Format", value: "Full-size" },
      { label: "Connexion", value: "USB-C" },
      { label: "Extras", value: "iCUE Wheel" },
    ],
    pros: [
      "iCUE Control Wheel unique et programmable",
      "Macro keys dédiées (6 touches)",
      "RGB per-key spectaculaire",
      "Construction solide cadre aluminium",
    ],
    cons: [
      "Encombrant (full-size + wheel)",
      "Pas de sans-fil",
      "iCUE consomme des ressources",
    ],
  ...
  },
  {
    ...
    tagline: "Le meilleur rapport qualité-prix custom",
    rating: 9.0,
    price: "149€",
    specs: [
      { label: "Switch", value: "Gateron Jupiter" },
      { label: "Format", value: "75%" },
      { label: "Connexion", value: "Triple (BT/2.4G/USB)" },
      { label: "Mount", value: "Gasket" },
    ],
    pros: [
      "Triple connectivité (Bluetooth + 2.4GHz + USB-C)",
      "Gasket mount pour un son premium",
      "Hot-swap pour changer les switches",
      "Prix agressif pour la qualité offerte",
    ],
    cons: [
      "Logiciel VIA moins intuitif que les concurrents",
      "RGB correct sans être exceptionnel",
      "Poids élevé (1.7kg) — pas portable",
    ],
  ...
  },
  {
    ...
    tagline: "L'esport dans un format compact",
    rating: 8.9,
    price: "179€",
    specs: [
      ...
      { label: "Connexion", value: "USB-C" },
      { label: "Actuation", value: "0.2-3.8mm" },
    ],
    pros: [
      "Switches OmniPoint ajustables (0.2-3.8mm)",
      "Écran OLED intégré (infos, GIF)",
      "Compact et robuste pour le transport",
      "Bonne qualité de frappe stock",
    ],
    cons: [
      "Écran OLED gadget (peu utile en pratique)",
      "Pas de hot-swap",
      "Sans-fil uniquement en version Wireless (plus chère)",
    ],
...
const faqItems: FAQItem[] = [
  {
    question: "Quelle est la différence entre un switch mécanique et un switch optique ?",
    answer: "Un switch mécanique utilise un contact physique en métal pour enregistrer la frappe, ce qui peut s'user avec le temps. Un switch optique utilise un faisceau lumineux, offrant une durabilité supérieure (100M+ frappes) et un temps de réponse théoriquement plus rapide. En pratique, la différence de vitesse est négligeable pour la plupart des joueurs.",
  },
  {
    question: "Le sans-fil a-t-il du lag pour le gaming ?",
    answer: "Non, les technologies sans-fil 2.4GHz modernes (Razer HyperSpeed, Logitech Lightspeed, etc.) offrent une latence inférieure à 1ms, identique au filaire. Le Bluetooth en revanche peut avoir 5-15ms de latence et n'est pas recommandé pour le gaming compétitif.",
  },
  {
    question: "Quel format de clavier choisir pour le gaming FPS ?",
    answer: "Le TKL (80%) est le format le plus populaire en FPS car il libère de l'espace pour les mouvements amples de souris tout en conservant les touches de fonction. Le 75% est un bon compromis si vous voulez encore plus compact. Évitez le full-size si vous avez une sensibilité souris basse.",
  },
  {
    question: "Les claviers Hall Effect valent-ils leur prix ?",
    answer: "Oui, si vous jouez en compétitif. L'actuation point ajustable (0.1mm) et le Rapid Trigger offrent un avantage réel en FPS en permettant des strafes plus rapides. Pour du gaming casual ou de la productivité, un bon mécanique classique reste suffisant et souvent moins cher.",
  },
  {
    question: "Faut-il investir dans un repose-poignet ?",
    answer: "Un repose-poignet ergonomique est fortement recommandé pour les sessions longues (3h+). Il réduit la pression sur le canal carpien et améliore le confort. Privilégiez les modèles en mousse à mémoire de forme ou en gel, pas en plastique dur.",
  },
  {
    question: "Comment entretenir son clavier mécanique ?",
    answer: "Dépoussiérez régulièrement avec de l'air comprimé, retirez les keycaps tous les 3-6 mois pour un nettoyage en profondeur (eau tiède + savon), et lubrifiez les switches si nécessaire (tous les 1-2 ans). Un clavier bien entretenu peut durer 10+ ans.",
  },
];
          ...
          picks={[
            {
              ...
              reason: "Imbattable en compétitif avec son actuation ajustable et Rapid Trigger.",
            },
            {
              icon: <Wallet className="h-8 w-8" />,
              label: "Meilleur Rapport Q/P",
              productName: "Keychron Q1 Max",
              reason: "Triple connectivité, gasket mount et hot-swap pour seulement 149€.",
            },
            {
              icon: <Zap className="h-8 w-8" />,
              label: "Meilleur Premium",
              productName: "Razer Huntsman V3 Pro",
              reason: "Le nec plus ultra en finition et technologie, pour les joueurs exigeants.",
            },
          ]}
