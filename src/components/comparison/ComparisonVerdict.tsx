      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-display font-bold mb-8">
            Verdict <span className="gradient-neon-text">Final</span>
          </h2>
          ...
          <div className="rounded-lg border border-primary/30 bg-primary/5 p-6 mb-8 box-glow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-display text-sm uppercase tracking-wider text-primary">Gagnant</span>
            </div>
            ...
            {verdicts.map((v) => (
              ...
              >
                ...
                <div className="space-y-3 mb-4">
                  <div>
                    <div className="flex items-center gap-1.5 text-xs text-primary mb-1.5">
                      ...
                      <span className="font-semibold uppercase tracking-wider">Points forts</span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center gap-1.5 text-xs text-destructive mb-1.5">
                      ...
                      <span className="font-semibold uppercase tracking-wider">Points faibles</span>
                    </div>
                    <ul className="space-y-1">
                ...
                <div className="pt-3 border-t border-border">
                  <span className="text-xs text-muted-foreground">Idéal pour : </span>
          ...
          <div className="rounded-lg border border-border bg-card p-6">
            <h3 className="font-display text-sm uppercase tracking-wider text-primary mb-3">Conclusion</h3>
