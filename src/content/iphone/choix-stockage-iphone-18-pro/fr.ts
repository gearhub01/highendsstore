  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Le stockage cloud peut aussi servir de complément : un abonnement iCloud décharge la mémoire interne et évite de choisir un palier supérieur uniquement pour conserver des archives.",
      ],
      showCta: true,
    },
  ],
