...
export const article: CollectionArticle = {
  ...
  sections: [
    ...
    {
      id: "tableau-complet",
      heading: "Le tableau 16 Pro / 18 Pro",
      paragraphs: [
        "Ce tableau se limite aux deux modèles comparés sur cette page : l'iPhone 16 Pro, documenté par Apple, et l'iPhone 18 Pro, dont la colonne reste vide jusqu'au keynote. C'est volontaire, et c'est la seule façon honnête de présenter un appareil non annoncé. Le tableau six colonnes couvrant les trois générations vit sur notre page de référence.",
      ],
      table: {
        headers: ["Caractéristique", "iPhone 16 Pro", "iPhone 18 Pro"],
        rows: [
          ["Écran", "6,3\" OLED, ProMotion jusqu'à 120 Hz", NC],
          ["Luminosité", "2 000 nits en pic extérieur", NC],
          ["Puce", "A18 Pro", "A20 Pro gravée en 2 nm — " + RUMOR],
          ["Modem", NC, "Modem C2 conçu par Apple — " + RUMOR],
          ["Stockage", "128 Go, 256 Go, 512 Go, 1 To", NC],
          [
            "Photo arrière",
            "48 Mpx Fusion + 48 Mpx ultra grand-angle + 12 Mpx téléobjectif 5x",
            "Ouverture variable — " + RUMOR,
          ],
          ["Zoom", "Téléobjectif 5x", NC],
          ["Caméra avant", "12 Mpx TrueDepth", NC],
          ["Vidéo", NC, NC],
          ["Autonomie", "Jusqu'à 27 h de lecture vidéo", NC],
          ["USB-C", "USB 3, jusqu'à 10 Gb/s", NC],
          ["Sans fil", NC, NC],
          ["Face ID", NC, "Face ID sous l'écran, avec des rapports contradictoires évoquant un report à 2027 — " + RUMOR],
          ["Matériau", "Titane, dos en verre mat texturé", NC],
          ["Poids", "199 g", NC],
          ["Coloris", "Noir, Blanc, Naturel, Désert", NC],
        ],
      },
    },
    {
